...
const browse = require("../../img/1x/browse-o.png");
const messages = require("../../img/1x/messages-b.png");
const profile = require("../../img/1x/profile-p.png");
const poUnselected = require("../../img/1x/po-l.png");
const browseUnselected = require("../../img/1x/browse-l.png");
const messagesUnselected = require("../../img/1x/messages-l.png");
const profileUnselected = require("../../img/1x/profile-l.png");
